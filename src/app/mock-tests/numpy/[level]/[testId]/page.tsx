...
export default function MockTestAttemptPage() {
  ...
  useEffect(() => {
    const loadQuestions = async () => {
      try {
        ...
        const mod = await import(`@/data/numpy/${level}/${formattedTestId}`);
  ...
  if (loading) {
    return (
      <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-50 flex items-center justify-center">
        <div className="text-center bg-white rounded-xl shadow-lg p-12 border border-blue-200">
          <div className="inline-block animate-spin rounded-full h-12 w-12 border-3 border-blue-300 border-t-blue-600 mb-6"></div>
          <h2 className="text-xl font-semibold text-blue-600 mb-2">
            Loading Your Test
          </h2>
          <p className="text-slate-500">
            Please wait while we prepare your NumPy questions
          </p>
        </div>
      </div>
    );
  ...
  if (questions.length === 0) {
    return (
      <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-50 flex items-center justify-center">
        <div className="max-w-md mx-auto text-center bg-white rounded-xl shadow-lg p-12 border border-blue-200">
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-50 pb-2.5 mt-4">
      {!showResult ? (
        <>
          {/* Header - Fixed at top */}
          <div className="bg-white shadow-lg border-b border-blue-200 flex-shrink-0 sticky top-0 z-40">
            <div className="container mx-auto px-1 pt-10 pb-4  max-w-6xl">
              <div className="bg-gradient-to-r from-blue-500 to-indigo-600 rounded-xl p-6 text-white">
                <div className="flex items-center justify-between mb-4">
                  <div>
                    <h1 className="text-2xl font-bold mb-2">NumPy Mock Test</h1>
                    <div className="flex items-center space-x-4 text-blue-100">
                      <span className="bg-white bg-opacity-20 px-3 py-1 rounded-full text-sm font-medium text-blue-500">
                  ...
                  <div className="text-right">
                    ...
                    <div className="text-blue-100 text-sm">of {questions.length}</div>
                  </div>
                </div>
          ...
          <div className="container mx-auto px-2 py-4 max-w-6xl">
            <div className="relative    w-full">
              ...
              <button
                ...
                className="absolute left-0 top-1/2 transform -translate-y-1/2 z-30 w-12 h-12 bg-white shadow-lg rounded-full border border-blue-200 hover:bg-blue-50 disabled:opacity-40 disabled:cursor-not-allowed transition-all duration-200 flex items-center justify-center group"
              ...
              <button
                ...
                onClick={goToNext}
                className="absolute right-0 top-1/2 transform -translate-y-1/2 z-30 w-12 h-12 bg-white shadow-lg rounded-full border border-blue-200 hover:bg-blue-50 disabled:opacity-40 disabled:cursor-not-allowed transition-all duration-200 flex items-center justify-center group"
              ...
              >
                ...
                <div
                  ...
                  className={`absolute top-0 left-0 w-full bg-white rounded-xl shadow-lg border border-blue-200 px-8 py-6
                    backface-hidden
                    ${
                      flipDirection === "next"
                        ? "origin-left"
                ...
                >
                  ...
                  <div className="flex items-center mb-6">
                    <div className="w-10 h-10 bg-gradient-to-r from-blue-500 to-indigo-600 rounded-lg flex items-center justify-center text-white font-bold text-lg mr-4">
                      {prevIndex + 1}
                    </div>
                ...
                <div
                  aria-hidden={flipStage !== "end"}
                  className={`absolute top-0 left-0 w-full bg-white rounded-xl shadow-lg border border-blue-200 px-8 py-6 overflow-y-auto
                    backface-hidden
                    ${
                      flipDirection === "next"
                        ? "origin-left"
                ...
                >
                      ...
                      return (
                        <label
                          ...
                          className={`block p-4 border-2 rounded-lg cursor-pointer transition-all duration-200 hover:shadow-sm ${
                            isSelected
                              ? "bg-gradient-to-r from-blue-500 to-indigo-600 text-white border-blue-500"
                              : "bg-blue-50 border-blue-200 hover:border-blue-300 text-black  hover:bg-blue-100"
                          }`}
                        >
                          <div className="flex items-center space-x-3">
                            <div
                  ...
                  {currentIndex === questions.length - 1 && !isTransitioning && (
                    <div className="border-t border-blue-200 pt-6 bg-white">
            ...
            <div className="bg-white rounded-xl shadow-lg border border-blue-200 overflow-hidden">
              <div className="bg-gradient-to-r from-green-600 to-green-700 p-8 text-center text-white">
                ...
                <p className="text-green-100">
                  Congratulations on finishing the NumPy test
                </p>
              </div>

              <div className="p-8">
                <div className="text-center mb-8">
                  <div className="inline-flex items-center justify-center w-32 h-32 bg-blue-50 rounded-full mb-6 border-4 border-blue-200">
                    <div className="text-center">
                  ...
                  <button
                    className="inline-flex items-center px-8 py-3 bg-blue-600 text-white font-semibold rounded-lg hover:bg-blue-700 transition-all duration-200 shadow-sm"
                    onClick={() => {
                      setShowResult(false);
                      setCurrentIndex(0);
