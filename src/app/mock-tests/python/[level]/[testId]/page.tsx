...
export default function MockTestAttemptPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-slate-100 pb-2.5 mt-4">
      {!showResult ? (
        <>
          {/* Header - Fixed at top */}
                      ...
                      return (
                        <label
                          ...
                          className={`block p-4 border-2 rounded-lg cursor-pointer transition-all duration-200 hover:shadow-sm ${
                            isSelected
                              ? "bg-[#004bac] text-white border-[#004bac]"
                              : "bg-slate-50 border-slate-200 hover:border-slate-300 text-black  hover:bg-slate-100"
                          }`}
                        >
                          <div className="flex items-center space-x-3">
                            <div
